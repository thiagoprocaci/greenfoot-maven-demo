# Greenfoot with Maven - Little Crab

This project is an adaptation of the Game chapter02-04/little-crab which can be found at [Greenfoot Book Scenarios website](https://www.greenfoot.org/book/material/book-scenarios.zip).
