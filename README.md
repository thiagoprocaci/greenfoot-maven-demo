# Greenfoot with Maven - Newtons Lab 3

This project is an adaptation of the Game chapter08/Newtons-Lab-3 which can be found at [Greenfoot Book Scenarios website](https://www.greenfoot.org/book/material/book-scenarios.zip).
