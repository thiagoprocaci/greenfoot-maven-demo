# Greenfoot with Maven - Newtons Lab 1

This project is an adaptation of the Game chapter08/Newtons-Lab-1 which can be found at [Greenfoot Book Scenarios website](https://www.greenfoot.org/book/material/book-scenarios.zip).
